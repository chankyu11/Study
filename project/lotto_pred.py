...
lo = lotto.iloc[:,0:6]
train = lotto.iloc[:454,0:6]
test = lotto.iloc[455:909,0:6]
pred = lotto.iloc[910:, 0:6]
# print(train)
# print(test)
...
hist = model.fit(x_train, y_train, epochs = 120, batch_size = 32, validation_split = 0.1)
