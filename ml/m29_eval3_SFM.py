...
for thresh in thresholds: #중요하지 않은 컬럼들을 하나씩 지워나간다.
    ...
    for thresh in thresholds:
        pickle.dump(selection_model, open("./model/xgb_save/iris/iris.pickle{}.dat".format(selection_x_train.shape[1]), "wb"))
...
Thresh=0.019, n=4, acc: 90.00%
Thresh=0.037, n=3, acc: 90.00%
Thresh=0.443, n=2, acc: 96.67%
Thresh=0.501, n=1, acc: 93.33%
acc: 100.00
'''