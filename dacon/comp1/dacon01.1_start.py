...
train = np.load('./dacon/comp1/train2.npy')
test = np.load('./dacon/comp1/test2.npy')
sample = np.load('./dacon/comp1/sample_submission2.npy')
...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size = 0.8, shuffle = True, random_state = 255)
...
model.fit(x_train_scaled, y_train, epochs = 100, validation_split = 0.25)
