...
# model = load_model('./model/test_weight1.h5')
model.summary()
...
# model.save('./model/model_test01.h5')
# model.save_weights('./model/model_test_weight1.h5')
...
# '''
# acc: [0.9406667, 0.9716111]
# val_acc: [0.08207844813819974, 0.07115718172009414]
# loss_acc: [0.06803766082841903, 0.9785000085830688]
