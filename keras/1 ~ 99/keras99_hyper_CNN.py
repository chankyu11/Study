...
def build_model(drop = 0.5, optimizer = 'adam'):
    ...
    x = Conv2D(20, (3,3), activation = 'relu', name = 'h1')(inputs)
    x = Dropout(drop)(x)
    x = Conv2D(128, (3,3), activation = 'relu', name = 'h2')(x)
    x = Dropout(drop)(x)
    x = Conv2D(64, (3,3), activation = 'relu', name = 'h3')(x)
    x = Dropout(drop)(x)
    x = Conv2D(32, (3,3), activation = 'relu', name = 'h4')(x)
    x = Dropout(drop)(x)
    x = Flatten()(x)
